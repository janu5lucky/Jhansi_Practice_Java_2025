...
public class prime_number_P04 {
	...
	//	primenumber_check_approach2(num);
		System.out.println(primenumber_check_approach3_boolean(num));
	...
	public static boolean primenumber_check_approach3_boolean(int num) {
		int count = 0;
		int i = 1;
		if (num >= 2) {
